...
if ( ! function_exists( 'newspaper_magazine_news_layout_three_register' ) ) :
	function newspaper_magazine_news_layout_three_register() {
		/**
		 * Register Widget
		 */
		register_widget( 'Newspaper_Magazine_News_Layout_Three' );
	}
endif;
add_action( 'widgets_init', 'newspaper_magazine_news_layout_three_register' );

if ( ! class_exists( 'Newspaper_Magazine_News_Layout_Three' ) ) :
	/**
	* News Layout Class Three
	*/
	class Newspaper_Magazine_News_Layout_Three extends WP_Widget
	{
		...
		function __construct()
		{
			$opts = array(
				...
				'description'	=> esc_html__( 'News Layout Widget Three', 'newspaper-magazine' )
			);
			                                    ...
			                                    <div class="block_article_content">
			                            	        ...
			                            	        <div class="author_time news_author">
			                                            ...
			                                            <span class="publish_date">
			                                            	...
			                                            	<a href="<?php the_permalink(); ?>" class="published_date"> 
