...
$options[] = array( 'name' => _x( 'Top Bar & Header', 'theme-options', 'the7mk2' ), 'type' => 'heading', 'id' => 'top-bar-header' );
...
$options[] = array( 'name' => _x( 'Sidebar & Footer', 'theme-options', 'the7mk2' ), 'type' => 'heading', 'id' => 'sidebar-footer' );
