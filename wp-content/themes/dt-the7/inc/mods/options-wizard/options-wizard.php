...
if ( ! class_exists( 'Presscore_Modules_OptionsWizardModule', false ) ) :
	...
	class Presscore_Modules_OptionsWizardModule {
		...
		public static function override_options_filter( $options ) {
			...
			// Headers color.
			$options['woocommerce_steps_color'] = $options['sidebar-headers_color'] = $options['general-title_color'] = $options['content-headers_color'];

			// Text font family.
			$options['top_bar-font-family'] = $options['header-menu-submenu-font-family'] = $options['header-mobile-submenu-font-family'] = $options['header-elements-near_menu-font_family'] = $options['header-elements-near_logo-font_family'] = $options['general-breadcrumbs_font_family'] = $options['fonts-font_family'];

			// Headers font family.
			$options['general-filter-font-family'] = $options['fonts-h2_font_family'] = $options['fonts-h3_font_family'] = $options['fonts-h4_font_family'] = $options['fonts-h5_font_family'] = $options['fonts-h6_font_family'] = $options['header-menu-font-family'] = $options['header-mobile-menu-font-family'] = $options['buttons-s_font_family'] = $options['buttons-m_font_family'] = $options['buttons-l_font_family'] = $options['general-font_family'] = $options['fonts-h1_font_family'];
			...
			switch( $header_layout ) {
				case 'classic':
					...
					$options['header-classic-elements-near_logo_left-padding'] = join( ' ', $padding );
					break;
				case 'slide_out':
				case 'overlay':
					if ( 'menu_icon' === $options["header-{$header_layout}-layout"] ) {
						$options['header-menu_icon-margin'] = '20px 20px 20px 20px';
						$options['header-style-mixed-logo-padding'] = '20px 20px 20px 20px';
					} elseif ( 'top_line' === $options["header-{$header_layout}-layout"] ) {
						$options['header-menu_icon-margin'] = '10px 10px 10px 10px';
						$options['header-style-mixed-logo-padding'] = '0px 20px 0px 20px';
						$options['header-style-floating-logo-padding'] = '0px 20px 0px 20px';
					} elseif ( 'side_line' === $options["header-{$header_layout}-layout"] ) {
						$options['header-menu_icon-margin'] = '10px 10px 10px 10px';
						$options['header-style-mixed-logo-padding'] = '10px 0px 10px 0px';
					}
            ...
            $header_menu_font_colors = array(
	            ...
	            'header-elements-near_menu-font_color',
	            'header-elements-near_logo-font_color',
            );
