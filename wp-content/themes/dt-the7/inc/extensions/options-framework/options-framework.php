...
function optionsframework_rolescheck() {
    ...
    if ( optionsframework_is_in_visual_mode() && optionsframework_get_options_files( $plugin_page ) ) {
...
function optionsframework_load_styles() {
	...
	wp_register_style( 'the7-alpha-color-picker', OPTIONS_FRAMEWORK_URL . 'css/alpha-color-picker.css', false, $theme_version );

	wp_enqueue_style( 'optionsframework', OPTIONS_FRAMEWORK_URL.'css/optionsframework.css', array( 'thickbox', 'wp-color-picker', 'the7-alpha-color-picker', 'optionsframework-jquery-ui', 'options-select2', 'the7-thickbox' ), $theme_version );
...
function optionsframework_load_scripts($hook) {
	...
	// Alpha color picker
	wp_register_script( 'the7-alpha-color-picker', OPTIONS_FRAMEWORK_URL . 'js/alpha-color-picker.js', array( 'jquery' ), $theme_version, true );

	// Enqueue custom option panel JS
	wp_enqueue_script( 'options-custom', OPTIONS_FRAMEWORK_URL . 'js/options-custom.js', array( 'jquery', 'wp-color-picker', 'the7-alpha-color-picker', 'thickbox', 'options-select2', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-widget', 'jquery-ui-sortable', 'jquery-form', 'jquery-ui-autocomplete' ), $theme_version, true );

	// Ajax options handler
	wp_enqueue_script( 'ajaxed-options', OPTIONS_FRAMEWORK_URL . 'js/ajaxed-options.js', array( 'jquery', 'jquery-form' ), $theme_version, true );
...
function optionsframework_is_in_backend_mode() {
    $mode = isset( $_COOKIE['the7-options-preview-mode'] ) ? $_COOKIE['the7-options-preview-mode'] : 'visual';
